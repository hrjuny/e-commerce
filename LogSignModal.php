                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          "image"></label>
                                          <div class="col-md-8">
                                        <input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small> I Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of Tipsy Shop.</small>
